...
class TaskAlignedAssigner(nn.Module):
    ...
    def iou_calculation(self, gt_bboxes, pd_bboxes):
        ...
        # return bbox_iou(gt_bboxes, pd_bboxes, xywh=False, ratio=1, GIoU=False, DIoU=False, CIoU=True, SIoU=False,
        #      EIoU=False, WIoU=False, MPDIoU=False, LMPDIoU=False, Inner=False, Focal=False, alpha=1, gamma=0.5,
        #      scale=False, eps=1e-7).squeeze(-1).clamp_(0)
        return bbox_iou(gt_bboxes, pd_bboxes, xywh=True, GIoU=False, DIoU=False, CIoU=False, EIoU=True, SIoU=False, WIoU=False,
             ShapeIoU=False,gamma=1,
             hw=1, mpdiou=False, Inner=True, Focaleriou=True, d=0.00, u=0.95, ratio=0.7, eps=1e-7, scale=0.0)[0].squeeze(-1).clamp_(0)
