...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask,hw):
        ...
        # iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, ratio=1, GIoU=False, DIoU=False, CIoU=True, SIoU=False,
        ...
        iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask],
                       ...
                       hw=hw[fg_mask], mpdiou=False, Inner=True, Focaleriou=True,
